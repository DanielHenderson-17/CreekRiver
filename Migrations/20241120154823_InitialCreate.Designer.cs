...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20241120154823_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://example.com/eagle-nest.jpg",
                        ...
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://example.com/bear-cave.jpg",
                            Nickname = "Bear Cave"
                        },
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://example.com/cedar-grove.jpg",
                            Nickname = "Cedar Grove"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 1,
                            ImageUrl = "https://example.com/deer-run.jpg",
                            Nickname = "Deer Run"
                        },
                        new
                        {
                            Id = 6,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://example.com/river-bend.jpg",
                            Nickname = "River Bend"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CheckoutDate = new DateTime(2024, 6, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 1
                        },
                        new
                        {
                            Id = 2,
                            CampsiteId = 3,
                            CheckinDate = new DateTime(2024, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckoutDate = new DateTime(2024, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 2
                        });
                });
