        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://example.com/eagle-nest.jpg", "Eagle's Nest" },
                    { 3, 3, "https://example.com/bear-cave.jpg", "Bear Cave" },
                    { 4, 4, "https://example.com/cedar-grove.jpg", "Cedar Grove" },
                    { 5, 1, "https://example.com/deer-run.jpg", "Deer Run" },
                    { 6, 2, "https://example.com/river-bend.jpg", "River Bend" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 3, new DateTime(2024, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
